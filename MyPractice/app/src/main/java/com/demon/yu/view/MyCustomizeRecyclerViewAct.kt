...
class MyCustomizeRecyclerViewAct : AppCompatActivity() {

    private var recyclerView: MyCustomizeRecyclerView? = null
    private var layoutManger: MyCustomizeLayoutManger? = null
    private val adapter = MyStaticAdapter()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_my_customize_recycler_act)
        ...
        recyclerView?.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                recyclerView as MyCustomizeRecyclerView
