...
//import androidx.recyclerview.widget.RecyclerForCloneXAvatar.ItemAnimator.ItemHolderInfo;
//
...
// */
//public class RecyclerForCloneXAvatar extends ViewGroup implements ScrollingView,
...
//     * {@link LayoutManager#onItemsChanged(RecyclerForCloneXAvatar)} should be called during the subsequent
//     * measure/layout.
//     *
//     * @see #processDataSetCompletelyChanged(boolean)
//     */
...
//            };
//
//    public RecyclerForCloneXAvatar(@NonNull Context context) {
//        this(context, null);
//    }
//
//    public RecyclerForCloneXAvatar(@NonNull Context context, @Nullable AttributeSet attrs) {
//        this(context, attrs, R.attr.recyclerViewStyle);
//    }
//
//    public RecyclerForCloneXAvatar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//            return className;
//        }
//        return RecyclerForCloneXAvatar.class.getPackage().getName() + '.' + className;
//    }
//
...
//                return RecyclerForCloneXAvatar.this.getChildCount();
//            }
//
//            @Override
...
//                }
//                RecyclerForCloneXAvatar.this.addView(child, index);
//                if (VERBOSE_TRACING) {
...
//                return RecyclerForCloneXAvatar.this.indexOfChild(view);
//            }
//
//            @Override
//            public void removeViewAt(int index) {
//                final View child = RecyclerForCloneXAvatar.this.getChildAt(index);
//                if (child != null) {
...
//                }
//                RecyclerForCloneXAvatar.this.removeViewAt(index);
//                if (VERBOSE_TRACING) {
//                    TraceCompat.endSection();
//                }
//            }
...
//                return RecyclerForCloneXAvatar.this.getChildAt(offset);
//            }
//
//            @Override
...
//                    child.clearAnimation();
//                }
//                RecyclerForCloneXAvatar.this.removeAllViews();
//            }
//
//            @Override
...
//                }
//                RecyclerForCloneXAvatar.this.attachViewToParent(child, index, layoutParams);
//            }
//
//            @Override
...
//                    }
//                }
//                RecyclerForCloneXAvatar.this.detachViewFromParent(offset);
//            }
//
//            @Override
...
//                final ViewHolder vh = getChildViewHolderInt(child);
//                if (vh != null) {
//                    vh.onEnteredHiddenState(RecyclerForCloneXAvatar.this);
//                }
//            }
//
//            @Override
...
//                final ViewHolder vh = getChildViewHolderInt(child);
//                if (vh != null) {
//                    vh.onLeftHiddenState(RecyclerForCloneXAvatar.this);
//                }
//            }
//        });
//    }
...
//                        mLayout.onItemsAdded(RecyclerForCloneXAvatar.this, op.positionStart, op.itemCount);
//                        break;
//                    case AdapterHelper.UpdateOp.REMOVE:
//                        mLayout.onItemsRemoved(RecyclerForCloneXAvatar.this, op.positionStart, op.itemCount);
//                        break;
//                    case AdapterHelper.UpdateOp.UPDATE:
//                        mLayout.onItemsUpdated(RecyclerForCloneXAvatar.this, op.positionStart, op.itemCount,
//                                op.payload);
//                        break;
//                    case AdapterHelper.UpdateOp.MOVE:
//                        mLayout.onItemsMoved(RecyclerForCloneXAvatar.this, op.positionStart, op.itemCount, 1);
//                        break;
//                }
//            }
//
...
//
//    /**
//     * Set a {@link OnFlingListener} for this {@link RecyclerForCloneXAvatar}.
//     * <p>
...
//
//    /**
//     * Get the current {@link OnFlingListener} from this {@link RecyclerForCloneXAvatar}.
//     *
...
//     * @see #addAnimatingView(RecyclerForCloneXAvatar.ViewHolder)
...
//     * {@link RecyclerForCloneXAvatar.LayoutManager#scrollToPosition(int)}
//     * @param position Scroll to this adapter position
//     * @see RecyclerForCloneXAvatar.LayoutManager#scrollToPosition(int)
//     */
...
//     * {@link LayoutManager#smoothScrollToPosition(RecyclerForCloneXAvatar, State, int)} and create a
//     * {@link SmoothScroller}.
//     * <p>
//     * {@link LayoutManager} is responsible for creating the actual scroll action. If you want to
//     * provide a custom smooth scroll logic, override
//     * {@link LayoutManager#smoothScrollToPosition(RecyclerForCloneXAvatar, State, int)} in your
//     * LayoutManager.
//     *
//     * @param position The adapter position to scroll to
//     * @see LayoutManager#smoothScrollToPosition(RecyclerForCloneXAvatar, State, int)
//     */
...
//     * {@link RecyclerForCloneXAvatar.LayoutManager#computeHorizontalScrollOffset(RecyclerForCloneXAvatar.State)} in your
//     * LayoutManager. </p>
//     *
//     * @return The horizontal offset of the scrollbar's thumb
//     * @see RecyclerForCloneXAvatar.LayoutManager#computeHorizontalScrollOffset
//     * (RecyclerView.State)
//     */
//    @Override
...
//     *
//     * <p>If you want to support scroll bars, override
//     * {@link RecyclerForCloneXAvatar.LayoutManager#computeHorizontalScrollExtent(RecyclerForCloneXAvatar.State)} in your
//     * LayoutManager.</p>
//     *
//     * @return The horizontal extent of the scrollbar's thumb
//     * @see RecyclerForCloneXAvatar.LayoutManager#computeHorizontalScrollExtent(RecyclerForCloneXAvatar.State)
//     */
//    @Override
...
//     *
//     * <p>If you want to support scroll bars, override
//     * {@link RecyclerForCloneXAvatar.LayoutManager#computeHorizontalScrollRange(RecyclerForCloneXAvatar.State)} in your
//     * LayoutManager.</p>
//     *
//     * @return The total horizontal range represented by the vertical scrollbar
//     * @see RecyclerForCloneXAvatar.LayoutManager#computeHorizontalScrollRange(RecyclerForCloneXAvatar.State)
//     */
//    @Override
...
//     *
//     * <p>If you want to support scroll bars, override
//     * {@link RecyclerForCloneXAvatar.LayoutManager#computeVerticalScrollOffset(RecyclerForCloneXAvatar.State)} in your
//     * LayoutManager.</p>
//     *
//     * @return The vertical offset of the scrollbar's thumb
//     * @see RecyclerForCloneXAvatar.LayoutManager#computeVerticalScrollOffset
//     * (RecyclerView.State)
//     */
//    @Override
...
//     *
//     * <p>If you want to support scroll bars, override
//     * {@link RecyclerForCloneXAvatar.LayoutManager#computeVerticalScrollExtent(RecyclerForCloneXAvatar.State)} in your
//     * LayoutManager.</p>
//     *
//     * @return The vertical extent of the scrollbar's thumb
//     * @see RecyclerForCloneXAvatar.LayoutManager#computeVerticalScrollExtent(RecyclerForCloneXAvatar.State)
//     */
//    @Override
...
//     *
//     * <p>If you want to support scroll bars, override
//     * {@link RecyclerForCloneXAvatar.LayoutManager#computeVerticalScrollRange(RecyclerForCloneXAvatar.State)} in your
//     * LayoutManager.</p>
//     *
//     * @return The total vertical range represented by the vertical scrollbar
//     * @see RecyclerForCloneXAvatar.LayoutManager#computeVerticalScrollRange(RecyclerForCloneXAvatar.State)
//     */
//    @Override
...
//     * {@link RecyclerForCloneXAvatar#requestLayout()}.  Doing so enables {@link RecyclerForCloneXAvatar} to avoid
...
//     * child View to cause a call to {@link RecyclerForCloneXAvatar#requestLayout()}.
//     *
...
//     * {@link RecyclerForCloneXAvatar#requestLayout()}.
//     * <p>
//     * A call to this method must always be accompanied by a call to
//     * {@link #startInterceptRequestLayout()} that precedes the code that may trigger a child
//     * View to cause a call to {@link RecyclerForCloneXAvatar#requestLayout()}.
//     *
...
//     * RecyclerForCloneXAvatar, State, int)}.
//     * <p>
...
//
//    /**
//     * Set a {@link EdgeEffectFactory} for this {@link RecyclerForCloneXAvatar}.
//     * <p>
...
//     * {@link EdgeEffectFactory#createEdgeEffect(RecyclerForCloneXAvatar, int)}
//     *
...
//     * returns true from
//     * {@link OnItemTouchListener#onInterceptTouchEvent(RecyclerForCloneXAvatar, MotionEvent)} its
//     * {@link OnItemTouchListener#onTouchEvent(RecyclerForCloneXAvatar, MotionEvent)} method will be called
...
//     *
//     * <p>Calls {@link OnItemTouchListener#onInterceptTouchEvent(RecyclerForCloneXAvatar, MotionEvent)} on each
...
//     * OnItemTouchListener to be called for future {@link RecyclerForCloneXAvatar#onTouchEvent(MotionEvent)}
...
//     * {@link LayoutManager#onItemsChanged(RecyclerForCloneXAvatar)} during measure/layout.
//     */
...
//                    postOnAnimation();
//                    if (mGapWorker != null) {
//                        mGapWorker.postFromTraversal(RecyclerForCloneXAvatar.this, consumedX, consumedY);
//                    }
//                }
//            }
//
...
//            ViewCompat.postOnAnimation(RecyclerForCloneXAvatar.this, this);
//        }
//
...
//                ViewCompat.postOnAnimation(RecyclerForCloneXAvatar.this, mUpdateChildViewsRunnable);
//            } else {
...
//     *
//     * @see RecyclerForCloneXAvatar#setEdgeEffectFactory(EdgeEffectFactory)
//     */
...
//         */
//        protected @NonNull EdgeEffect createEdgeEffect(@NonNull RecyclerForCloneXAvatar view,
...
//     * and use {@link RecyclerForCloneXAvatar#setRecycledViewPool(RecycledViewPool)}.
//     * <p>
...
//     */
//    @Nullable
//    static RecyclerForCloneXAvatar findNestedRecyclerView(@NonNull View view) {
//        if (!(view instanceof ViewGroup)) {
//            return null;
//        }
//        if (view instanceof RecyclerForCloneXAvatar) {
//            return (RecyclerForCloneXAvatar) view;
//        }
//        final ViewGroup parent = (ViewGroup) view;
//        final int count = parent.getChildCount();
//        for (int i = 0; i < count; i++) {
//            final View child = parent.getChildAt(i);
//            final RecyclerForCloneXAvatar descendant = findNestedRecyclerView(child);
//            if (descendant != null) {
//                return descendant;
//            }
//        }
...
//            holder.mOwnerRecyclerView = RecyclerForCloneXAvatar.this;
...
//                        return null;
//                    }
//                    holder = mAdapter.createViewHolder(RecyclerForCloneXAvatar.this, type);
//                    if (ALLOW_THREAD_GAP_WORK) {
//                        // only bother finding nested RV if prefetching
//                        RecyclerForCloneXAvatar innerView = findNestedRecyclerView(holder.itemView);
//                        if (innerView != null) {
...
//                    if (layoutIndex == RecyclerForCloneXAvatar.NO_POSITION) {
...
//     * within a {@link RecyclerForCloneXAvatar}.</p>
//     *
...
//            if (layoutParams instanceof RecyclerForCloneXAvatar.LayoutParams) {
...
//         * needs to be attached to its parent {@link RecyclerForCloneXAvatar}. This can be because it has
...
//         * <p>
//         * Note that when all animations are created by {@link RecyclerForCloneXAvatar.ItemAnimator}, you
...
//         * {@link #onViewDetachedFromWindow(RecyclerForCloneXAvatar.ViewHolder) onViewDetachedFromWindow}
...
//         * {@link RecyclerForCloneXAvatar.AdapterDataObserver#onChanged()
//         * "something changed"} event if more specific data is not available.</p>
//         *
//         * <p>Components registering observers with an adapter are responsible for
//         * {@link #unregisterAdapterDataObserver(RecyclerForCloneXAvatar.AdapterDataObserver)
//         * unregistering} those observers when finished.</p>
//         *
//         * @param observer Observer to register
//         *
//         * @see #unregisterAdapterDataObserver(RecyclerForCloneXAvatar.AdapterDataObserver)
//         */
...
//         *
//         * @see #registerAdapterDataObserver(RecyclerForCloneXAvatar.AdapterDataObserver)
//         */
...
//         * @see #onDetachedFromRecyclerView(RecyclerForCloneXAvatar)
//         */
//        public void onAttachedToRecyclerView(@NonNull RecyclerForCloneXAvatar recyclerView) {
//        }
//
//        /**
...
//         * @see #onAttachedToRecyclerView(RecyclerForCloneXAvatar)
//         */
//        public void onDetachedFromRecyclerView(@NonNull RecyclerForCloneXAvatar recyclerView) {
//        }
//
//        /**
...
//        ChildHelper mChildHelper;
//        RecyclerForCloneXAvatar mRecyclerView;
//
//        /**
...
//                        final RecyclerForCloneXAvatar.LayoutParams params = (RecyclerForCloneXAvatar.LayoutParams)
...
//        }
//
//        void setRecyclerView(RecyclerForCloneXAvatar recyclerView) {
...
//         * measurement specs that were passed into {@link RecyclerForCloneXAvatar#onMeasure(int, int)}. It is
...
//         * {@link RecyclerForCloneXAvatar#onMeasure(int, int)}.
//         * <p>
...
//         * {@link RecyclerForCloneXAvatar} or if it should be done by the LayoutManager's implementation of
...
//         * {@link RecyclerForCloneXAvatar#onMeasure(int, int)}, and then calculating desired dimensions based
...
//         * More specifically:
//         * <ol>
//         * <li>When {@link RecyclerForCloneXAvatar#onMeasure(int, int)} is called, if the provided measure
...
//         * <li>Any following calls to {@link RecyclerForCloneXAvatar#onMeasure(int, int)} will run
//         * {@link #onLayoutChildren(Recycler, State)} with {@link State#isMeasuring()} set to
...
//         * mechanism of {@link RecyclerForCloneXAvatar} or <code>False</code> if it should be done by the
...
//         * {@link RecyclerForCloneXAvatar#setItemAnimator(ItemAnimator) ItemAnimator} set on the
...
//                LayoutPrefetchRegistry layoutPrefetchRegistry) {}
//
//        void dispatchAttachedToWindow(RecyclerForCloneXAvatar view) {
//            mIsAttachedToWindow = true;
//            onAttachedToWindow(view);
//        }
//
//        void dispatchDetachedFromWindow(RecyclerForCloneXAvatar view, Recycler recycler) {
...
//         *
//         * @see #onDetachedFromWindow(RecyclerForCloneXAvatar, Recycler)
//         */
//        @CallSuper
//        public void onAttachedToWindow(RecyclerForCloneXAvatar view) {
//        }
//
//        /**
//         * @deprecated
//         * override {@link #onDetachedFromWindow(RecyclerForCloneXAvatar, Recycler)}
//         */
//        @Deprecated
//        public void onDetachedFromWindow(RecyclerForCloneXAvatar view) {
//
//        }
//
//        /**
...
//         * call {@link RecyclerForCloneXAvatar#requestLayout()} to ensure that it is re-laid out when
...
//         *                 keeping them around.
//         *
//         * @see #onAttachedToWindow(RecyclerForCloneXAvatar)
//         */
//        @CallSuper
//        public void onDetachedFromWindow(RecyclerForCloneXAvatar view, Recycler recycler) {
...
//         * {@link RecyclerForCloneXAvatar.LayoutParams} for this purpose.</p>
//         *
...
//         * @param position Scroll to this adapter position.
//         */
//        public void smoothScrollToPosition(RecyclerForCloneXAvatar recyclerView, State state,
//                                           int position) {
...
//         * @see RecyclerForCloneXAvatar.ItemAnimator#endAnimations()
//         */
...
//            return ((RecyclerForCloneXAvatar.LayoutParams) view.getLayoutParams()).getViewLayoutPosition();
//        }
//
//        /**
...
//         *
//         * @see RecyclerForCloneXAvatar#getChildViewHolder(View)
//         * @see RecyclerForCloneXAvatar#findContainingViewHolder(View)
//         */
//        @Nullable
//        public View findContainingItemView(@NonNull View view) {
//            if (mRecyclerView == null) {
...
//         * will want to use {@link #detachAndScrapView(android.view.View, RecyclerForCloneXAvatar.Recycler)}
...
//         * {@link #attachView(android.view.View, int, RecyclerForCloneXAvatar.LayoutParams) reattach}
...
//         * {@link #detachAndScrapView(android.view.View, RecyclerForCloneXAvatar.Recycler)}  scrapped}.
//         *
...
//         *
//         * <p>This value is usually equal to the laid out width of the {@link RecyclerForCloneXAvatar} but may
...
//         *
//         * <p>This value is usually equal to the laid out height of the {@link RecyclerForCloneXAvatar} but may
...
//         */
//        public void getDecoratedBoundsWithMargins(@NonNull View view, @NonNull Rect outBounds) {
//            RecyclerForCloneXAvatar.getDecoratedBoundsWithMarginsInt(view, outBounds);
//        }
//
//        /**
...
//         * then {@link #onFocusSearchFailed(View, int, RecyclerForCloneXAvatar.Recycler, RecyclerForCloneXAvatar.State)}
...
//         */
//        public boolean requestChildRectangleOnScreen(@NonNull RecyclerForCloneXAvatar parent,
...
//         */
//        private boolean isFocusedChildVisibleAfterScrolling(RecyclerForCloneXAvatar parent, int dx, int dy) {
...
//
//        /**
//         * @deprecated Use {@link #onRequestChildFocus(RecyclerForCloneXAvatar, State, View, View)}
//         */
//        @Deprecated
//        public boolean onRequestChildFocus(@NonNull RecyclerForCloneXAvatar parent, @NonNull View child,
...
//         */
//        public boolean onRequestChildFocus(@NonNull RecyclerForCloneXAvatar parent, @NonNull State state,
...
//         * {@link RecyclerForCloneXAvatar#setAdapter(Adapter)} or
//         * {@link RecyclerForCloneXAvatar#swapAdapter(Adapter, boolean)}. The LayoutManager may use this
...
//         *                   {@link #setAdapter(RecyclerForCloneXAvatar.Adapter)} is called with {@code null}.
//         */
...
//         */
//        public boolean onAddFocusables(@NonNull RecyclerForCloneXAvatar recyclerView,
...
//         * {@link RecyclerForCloneXAvatar#swapAdapter(Adapter, boolean)} ()} and signals that the the entire
//         * data set has changed.
//         *
//         * @param recyclerView
//         */
//        public void onItemsChanged(@NonNull RecyclerForCloneXAvatar recyclerView) {
//        }
//
//        /**
...
//         * @param itemCount
//         */
//        public void onItemsAdded(@NonNull RecyclerForCloneXAvatar recyclerView, int positionStart,
//                                 int itemCount) {
//        }
//
//        /**
...
//         * @param itemCount
//         */
//        public void onItemsRemoved(@NonNull RecyclerForCloneXAvatar recyclerView, int positionStart,
//                                   int itemCount) {
//        }
//
//        /**
//         * Called when items have been changed in the adapter.
//         * To receive payload,  override {@link #onItemsUpdated(RecyclerForCloneXAvatar, int, int, Object)}
...
//         * @param itemCount
//         */
//        public void onItemsUpdated(@NonNull RecyclerForCloneXAvatar recyclerView, int positionStart,
//                                   int itemCount) {
//        }
//
//        /**
//         * Called when items have been changed in the adapter and with optional payload.
//         * Default implementation calls {@link #onItemsUpdated(RecyclerForCloneXAvatar, int, int)}.
//         *
//         * @param recyclerView
//         * @param positionStart
//         * @param itemCount
...
//         * @param itemCount
//         */
//        public void onItemsMoved(@NonNull RecyclerForCloneXAvatar recyclerView, int from, int to,
//                                 int itemCount) {
//
//        }
//
...
//         *
//         * <p>Read {@link RecyclerForCloneXAvatar#computeHorizontalScrollExtent()} for details.</p>
//         *
//         * <p>Default implementation returns 0.</p>
//         *
//         * @param state Current state of RecyclerView
//         * @return The horizontal extent of the scrollbar's thumb
//         * @see RecyclerForCloneXAvatar#computeHorizontalScrollExtent()
//         */
...
//         * <p>Override this method if you want to support scroll bars.</p>
//         *
//         * <p>Read {@link RecyclerForCloneXAvatar#computeHorizontalScrollOffset()} for details.</p>
//         *
//         * <p>Default implementation returns 0.</p>
//         *
//         * @param state Current State of RecyclerView where you can find total item count
//         * @return The horizontal offset of the scrollbar's thumb
//         * @see RecyclerForCloneXAvatar#computeHorizontalScrollOffset()
//         */
...
//         * <p>Override this method if you want to support scroll bars.</p>
//         *
//         * <p>Read {@link RecyclerForCloneXAvatar#computeHorizontalScrollRange()} for details.</p>
//         *
//         * <p>Default implementation returns 0.</p>
//         *
//         * @param state Current State of RecyclerView where you can find total item count
//         * @return The total horizontal range represented by the vertical scrollbar
//         * @see RecyclerForCloneXAvatar#computeHorizontalScrollRange()
//         */
...
//         * <p>Override this method if you want to support scroll bars.</p>
//         *
//         * <p>Read {@link RecyclerForCloneXAvatar#computeVerticalScrollExtent()} for details.</p>
//         *
//         * <p>Default implementation returns 0.</p>
//         *
//         * @param state Current state of RecyclerView
//         * @return The vertical extent of the scrollbar's thumb
//         * @see RecyclerForCloneXAvatar#computeVerticalScrollExtent()
//         */
...
//         * <p>Override this method if you want to support scroll bars.</p>
//         *
//         * <p>Read {@link RecyclerForCloneXAvatar#computeVerticalScrollOffset()} for details.</p>
//         *
//         * <p>Default implementation returns 0.</p>
//         *
//         * @param state Current State of RecyclerView where you can find total item count
//         * @return The vertical offset of the scrollbar's thumb
//         * @see RecyclerForCloneXAvatar#computeVerticalScrollOffset()
//         */
...
//         * <p>Override this method if you want to support scroll bars.</p>
//         *
//         * <p>Read {@link RecyclerForCloneXAvatar#computeVerticalScrollRange()} for details.</p>
//         *
//         * <p>Default implementation returns 0.</p>
//         *
//         * @param state Current State of RecyclerView where you can find total item count
//         * @return The total vertical range represented by the vertical scrollbar
//         * @see RecyclerForCloneXAvatar#computeVerticalScrollRange()
//         */
...
//         * <p>
//         * You should override
//         * {@link #getRowCountForAccessibility(RecyclerForCloneXAvatar.Recycler, RecyclerForCloneXAvatar.State)},
//         * {@link #getColumnCountForAccessibility(RecyclerForCloneXAvatar.Recycler, RecyclerForCloneXAvatar.State)},
//         * {@link #isLayoutHierarchical(RecyclerForCloneXAvatar.Recycler, RecyclerForCloneXAvatar.State)} and
//         * {@link #getSelectionModeForAccessibility(RecyclerForCloneXAvatar.Recycler, RecyclerForCloneXAvatar.State)} for
...
//         * @see #getRowCountForAccessibility(RecyclerForCloneXAvatar.Recycler, RecyclerForCloneXAvatar.State)
//         * @see #getColumnCountForAccessibility(RecyclerForCloneXAvatar.Recycler, RecyclerForCloneXAvatar.State)
//         * @see #isLayoutHierarchical(RecyclerForCloneXAvatar.Recycler, RecyclerForCloneXAvatar.State)
//         * @see #getSelectionModeForAccessibility(RecyclerForCloneXAvatar.Recycler, RecyclerForCloneXAvatar.State)
//         */
...
//        }
//
//        void setExactMeasureSpecsFrom(RecyclerForCloneXAvatar recyclerView) {
//            setMeasureSpecs(
...
//     * views (in {@link ItemDecoration#onDraw(Canvas, RecyclerForCloneXAvatar, RecyclerForCloneXAvatar.State) onDraw()}
//     * and after the items (in {@link ItemDecoration#onDrawOver(Canvas, RecyclerForCloneXAvatar,
//     * RecyclerForCloneXAvatar.State)}.</p>
//     */
...
//         * @param state The current state of RecyclerView
//         */
//        public void onDraw(@NonNull Canvas c, @NonNull RecyclerForCloneXAvatar parent, @NonNull State state) {
//            onDraw(c, parent);
//        }
//
//        /**
//         * @deprecated
//         * Override {@link #onDraw(Canvas, RecyclerForCloneXAvatar, RecyclerForCloneXAvatar.State)}
//         */
//        @Deprecated
//        public void onDraw(@NonNull Canvas c, @NonNull RecyclerForCloneXAvatar parent) {
//        }
//
//        /**
//         * Draw any appropriate decorations into the Canvas supplied to the RecyclerView.
...
//         * @param state The current state of RecyclerView.
//         */
//        public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerForCloneXAvatar parent,
//                @NonNull State state) {
//            onDrawOver(c, parent);
//        }
//
//        /**
//         * @deprecated
//         * Override {@link #onDrawOver(Canvas, RecyclerForCloneXAvatar, RecyclerForCloneXAvatar.State)}
//         */
//        @Deprecated
//        public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerForCloneXAvatar parent) {
//        }
...
//        /**
//         * @deprecated
//         * Use {@link #getItemOffsets(Rect, View, RecyclerForCloneXAvatar, State)}
//         */
//        @Deprecated
//        public void getItemOffsets(@NonNull Rect outRect, int itemPosition,
//                @NonNull RecyclerForCloneXAvatar parent) {
//            outRect.set(0, 0, 0, 0);
//        }
//
//        /**
...
//         * {@link RecyclerForCloneXAvatar#getChildAdapterPosition(View)} to get the adapter position of the
//         * View.
//         *
...
//                                   @NonNull RecyclerForCloneXAvatar parent, @NonNull State state) {
...
//         *         the gesture.
//         */
//        boolean onInterceptTouchEvent(@NonNull RecyclerForCloneXAvatar rv, @NonNull MotionEvent e);
//
//        /**
...
//         *          the RecyclerView's coordinate system.
//         */
//        void onTouchEvent(@NonNull RecyclerForCloneXAvatar rv, @NonNull MotionEvent e);
//
//        /**
...
//
//    /**
//     * An implementation of {@link RecyclerForCloneXAvatar.OnItemTouchListener} that has empty method bodies
...
//     */
//    public static class SimpleOnItemTouchListener implements RecyclerForCloneXAvatar.OnItemTouchListener {
//        @Override
//        public boolean onInterceptTouchEvent(@NonNull RecyclerForCloneXAvatar rv, @NonNull MotionEvent e) {
//            return false;
//        }
//
//        @Override
//        public void onTouchEvent(@NonNull RecyclerForCloneXAvatar rv, @NonNull MotionEvent e) {
//        }
//
//        @Override
...
//     * <p>
//     * @see RecyclerForCloneXAvatar#addOnScrollListener(OnScrollListener)
//     * @see RecyclerForCloneXAvatar#clearOnChildAttachStateChangeListeners()
//     *
//     */
...
//         *                     {@link #SCROLL_STATE_DRAGGING} or {@link #SCROLL_STATE_SETTLING}.
//         */
//        public void onScrollStateChanged(@NonNull RecyclerForCloneXAvatar recyclerView, int newState){}
//
//        /**
...
//         */
//        public void onScrolled(@NonNull RecyclerForCloneXAvatar recyclerView, int dx, int dy){}
//    }
//
//    /**
...
//     * a view is recycled.
//     *
//     * @see RecyclerForCloneXAvatar#setRecyclerListener(RecyclerListener)
//     */
...
//        WeakReference<RecyclerForCloneXAvatar> mNestedRecyclerView;
...
//         * {@link RecycledViewPool}.
//         */
//        RecyclerForCloneXAvatar mOwnerRecyclerView;
//
...
//         * positions. All methods in {@link RecyclerForCloneXAvatar.LayoutManager}, {@link RecyclerForCloneXAvatar.State},
//         * {@link RecyclerForCloneXAvatar.Recycler} that receive a position expect it to be the layout position
//         * of the item.
//         * <p>
//         * If LayoutManager needs to call an external method that requires the adapter position of
//         * the item, it can use {@link #getAdapterPosition()} or
//         * {@link RecyclerForCloneXAvatar.Recycler#convertPreLayoutPositionToPostLayout(int)}.
//         *
...
//         * <p>
//         * Note that if you've called {@link RecyclerForCloneXAvatar.Adapter#notifyDataSetChanged()}, until the
//         * next layout pass, the return value of this method will be {@link #NO_POSITION}.
//         *
//         * @return The adapter position of the item if it still exists in the adapter.
//         * {@link RecyclerForCloneXAvatar#NO_POSITION} if item has been removed from the adapter,
//         * {@link RecyclerForCloneXAvatar.Adapter#notifyDataSetChanged()} has been called after the last
...
//         *
//         * @return The item's id if adapter has stable ids, {@link RecyclerForCloneXAvatar#NO_ID}
//         * otherwise
//         */
...
//         */
//        void onEnteredHiddenState(RecyclerForCloneXAvatar parent) {
...
//         */
//        void onLeftHiddenState(RecyclerForCloneXAvatar parent) {
//            parent.setChildImportantForAccessibilityInternal(this,
//                    mWasImportantForAccessibilityBeforeHidden);
//            mWasImportantForAccessibilityBeforeHidden = ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO;
//        }
...
//                || !viewHolder.isBound()) {
//            return RecyclerForCloneXAvatar.NO_POSITION;
//        }
...
//     * {@link RecyclerForCloneXAvatar}. Custom {@link LayoutManager layout managers} are encouraged
...
//         * {@link RecyclerForCloneXAvatar#NO_POSITION} if item represented by this View has been removed or
...
//
//        private int mTargetPosition = RecyclerForCloneXAvatar.NO_POSITION;
//
//        private RecyclerForCloneXAvatar mRecyclerView;
//
...
//         * <p>In each animation step, {@link RecyclerForCloneXAvatar} will check
//         * for the target view and call either
//         * {@link #onTargetFound(android.view.View, RecyclerForCloneXAvatar.State, SmoothScroller.Action)} or
//         * {@link #onSeekTargetStep(int, int, RecyclerForCloneXAvatar.State, SmoothScroller.Action)} until
...
//         */
//        void start(RecyclerForCloneXAvatar recyclerView, LayoutManager layoutManager) {
//
...
//            if (mTargetPosition == RecyclerForCloneXAvatar.NO_POSITION) {
...
//         * {@link #onTargetFound(android.view.View, RecyclerForCloneXAvatar.State, SmoothScroller.Action)} or
//         * {@link #onSeekTargetStep(int, int, RecyclerForCloneXAvatar.State, SmoothScroller.Action)}.
//         */
...
//            mRunning = false;
//            onStop();
//            mRecyclerView.mState.mTargetPosition = RecyclerForCloneXAvatar.NO_POSITION;
//            mTargetView = null;
//            mTargetPosition = RecyclerForCloneXAvatar.NO_POSITION;
...
//         * {@link RecyclerForCloneXAvatar#NO_POSITION} if no target view is set.
//         */
...
//            final RecyclerForCloneXAvatar recyclerView = mRecyclerView;
//            if (mTargetPosition == RecyclerForCloneXAvatar.NO_POSITION || recyclerView == null) {
//                stop();
//            }
//
...
//
//        /**
//         * @see RecyclerForCloneXAvatar#getChildLayoutPosition(android.view.View)
//         */
...
//
//        /**
//         * @see RecyclerForCloneXAvatar.LayoutManager#getChildCount()
//         */
//        public int getChildCount() {
...
//
//        /**
//         * @see RecyclerForCloneXAvatar.LayoutManager#findViewByPosition(int)
//         */
//        public View findViewByPosition(int position) {
...
//
//        /**
//         * @see RecyclerForCloneXAvatar#scrollToPosition(int)
...
//
//            public static final int UNDEFINED_DURATION = RecyclerForCloneXAvatar.UNDEFINED_DURATION;
//
//            private int mDx;
//
//            private int mDy;
...
//             * {@link RecyclerForCloneXAvatar#scrollToPosition(int)}.
//             * <p>
...
//            }
//
//            void runIfNecessary(RecyclerForCloneXAvatar recyclerView) {
...
//
//        /**
//         * An interface which is optionally implemented by custom {@link RecyclerForCloneXAvatar.LayoutManager}
...
//        int mTargetPosition = RecyclerForCloneXAvatar.NO_POSITION;
//
...
//
//        /**
//         * True if the associated {@link RecyclerForCloneXAvatar} is in the pre-layout step where it is having
...
//
//        /**
//         * Returns true if the {@link RecyclerForCloneXAvatar} is in the pre-layout step where it is having its
...
//         * {@link RecyclerForCloneXAvatar#NO_POSITION} if there is no target
//         * position.
//         */
...
//            return mTargetPosition != RecyclerForCloneXAvatar.NO_POSITION;
//        }
//
//        /**
...
//         *                 {@link RecyclerForCloneXAvatar.Adapter#notifyDataSetChanged()}. The same list of
//         *                 payloads will be passed into
//         *                 {@link RecyclerForCloneXAvatar.Adapter#onBindViewHolder(ViewHolder, int, List)}
...
//         * {@link #recordPreLayoutInformation(RecyclerForCloneXAvatar.State, ViewHolder, int, List)} and
//         * {@link #recordPostLayoutInformation(RecyclerForCloneXAvatar.State, ViewHolder)} returns this data
...
//            /**
//             * The change flags that were passed to
//             * {@link #recordPreLayoutInformation(RecyclerForCloneXAvatar.State, ViewHolder, int, List)}.
//             */
//            @AdapterChanges
...
//             */
//            @NonNull
//            public ItemHolderInfo setFrom(@NonNull RecyclerForCloneXAvatar.ViewHolder holder) {
...
//             *               {@link #recordPreLayoutInformation(RecyclerForCloneXAvatar.State, ViewHolder, int,
//             *               List)}.
//             * @return This {@link ItemHolderInfo}
//             */
//            @NonNull
...
//         *
//         * @see RecyclerForCloneXAvatar#setChildDrawingOrderCallback(RecyclerForCloneXAvatar.ChildDrawingOrderCallback)
//         */
